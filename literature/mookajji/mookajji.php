...
<div class="container">
	<br>
	<img src="mookajji.jpg" style="height:300px; float:left;">
	
	<p align="center" style="font-size: 35px; font-family: Microsoft Yi Baiti; margin-top: 20px;float:left; color: #999;">"ಮೂಕಜ್ಜಿಯ ಕನಸುಗಳು | Mookajjiya Kanasugalu<br>
by Kota Shivarama Karanth"</p>

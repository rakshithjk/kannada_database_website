...
<div class="container">
	<br>
	<img src="uturn.jpg" style="width:100%;height:500px;">
	
	<p align="center" style="font-size: 65px;;font-family: Microsoft Yi Baiti; margin-top: 20px; color: #ff00ff;"><b>"U Turn"</b></p>
...
<div>
	<ul style="font-size: 30px;margin-left: 100px; font-family: Microsoft Yi Baiti; margin-top: 20px; color: #ff8000 ;">
		<li>Karma Karma-U Turn</li>
		<li>Go Take That U Turn-U Turn</li>
		<li>Go Take That</li>
		<li>U Turn-U Turn</li>

...
<div>
	<ul style="font-size: 30px;margin-left: 100px; font-family: Microsoft Yi Baiti; margin-top: 20px; color: #ff8000 ;">
		<li>Tiger Dance</li>
		<li>Gaatiya Ilidu</li>
		<li>Ulidavaru Kandanthe Promotional Song</li>
		<li>Ulidavaru Kandanthe Promotional Song 1</li>
		<li>Theme Of Ulidavaru Kandanthe</li>
		<li>The Final Showdown</li>
		<li>Richi Theme</li>
		<li>Paper Paper Medicine Paper</li>
</ul>
</div>
</body>
<script>
